...
$sql_usuari = "SELECT * FROM tbl_usuari WHERE usu_id='$usu'";
	$usuaris=mysqli_query($conexion, $sql_usuari);
		...
		echo "<form id='form' method='post' enctype='multipart/form-data' onsubmit='return validarForm();' action='../../proc/usuario_mod.proc.php'>";
			...
			echo "<input type='submit' name='enviar' value='Guardar Canvis'>";
	echo "</form>";
	?>
